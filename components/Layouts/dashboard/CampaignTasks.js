...
const CampaignTasks = ({campaignTasks}) => {
  ...
  return (
    ...
    <h6><b style={{color: 'rgb(60,141,188)'}}><Link href='/campaintasks'><a style={{color: 'rgb(60,141,188)'}}>Campaign Tasks</a></Link></b></h6>
        <hr/>
        <div className="" style={{ minHeight: '48vh', maxHeight: '48vh', overflowY:'auto'}}>
                                ...
                                <td>
                                    {
                                        (moment(task.end_date,"YYYY/MM/DD").diff(moment(date,"YYYY/MM/DD"),'days')).toString().charAt(0)=='-'?
                                            <span style={{color:"red"}}>{moment(task.end_date,"YYYY/MM/DD").diff(moment(date,"YYYY/MM/DD"),'days').toString().slice(1,10) + " Days Due"}</span>:
                                                moment(task.end_date,"YYYY/MM/DD").diff(moment(date,"YYYY/MM/DD"),'days').toString()=='0'?<span style={{color:"orange"}}>Last Day!</span>:
